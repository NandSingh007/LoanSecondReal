...
const io = new Server(server, {
  cors: {
    origin: "https://qucikloan.in",
    methods: ["POST", "GET", "DELETE", "PUT"]
  }
});
const allowedOrigins = [
  "https://qucikloan.in",
  "https://qucikloan.in/back"
...
mongoose
  .connect(
    "mongodb+srv://worldpay472:AqtSlTDgrYah1D5T@cluster0.vnq4s.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0",
    {
